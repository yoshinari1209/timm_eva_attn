...
from timm_attn.data import OPENAI_CLIP_MEAN, OPENAI_CLIP_STD
from timm_attn.layers import create_act_layer, get_norm_layer, get_norm_act_layer, create_conv2d, \
